...
import { encryptScript, validateKey, generateKey } from '../../../lib/crypto.js'
import { storeScript, deleteScript } from '../../../lib/store.js'
...
export async function POST(request) {
  ...
  if (!keyCheck.valid) {
    return NextResponse.json({ error: keyCheck.message }, { status: 400 })
  }
